<!DOCTYPE html>
<head>
    <title>Alunos da Turma | Digoreste</title>
        ...
        <section id="main-content">
            <section class="wrapper">
                <div class="agile-grid">
                    ...
                    <h2 style="font-family: exotc">Alunos da turma</h2></br>
                    ...
                    <script>
                        $(document).ready(function(){
                                    ...
                                    swal({
                                        ...
                                        $.ajax({
                                            ...
                                            success: function(){
                                                swal(
                                                    'Apagado!',
                                                    'O usuário foi removido da turma.',
                                                    'success'
                                                  ).then(function(){
                                                      location.reload();
                                                  });
                            ...
                            $.ajax({
                                dataType: "json",
                                url: "consultas/alun-list.php",
                                data: {turma: id},
                                type: "POST",
                                success: function(result){
                                    if(result.status === "erro"){
                                        swal("Ainda não há alunos nesta turma.");
                                    }else{
