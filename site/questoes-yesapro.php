<!DOCTYPE html>
<head>
    <title>Banco de Questões | Digoreste</title>
        ...
        <section id="main-content">
            <section class="wrapper">
                <div class="agile-grid">
                    ...
                    <h2 style="font-family: exotc">Banco de Questões</h2></br>
                    ...
                    <script>
                        ...
                        $(document).ready(function(){
                            $.ajax({
                                dataType: "json",
                                url: "consultas/ques-list-yesapro.php",
                                type: "POST",
                                success: function(result){
                                    if(result.status === "erro"){
                                        swal("Ainda não há questões aprovadas no banco de questões.");
                                    }else{
