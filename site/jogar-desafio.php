                ...
                <div class="agile-grid" id="campo">
                    ...
                    <script>
                        ...
                        function pergunta(){
                            $.ajax({
                                dataType: "json",
                                url: "consultas/pergunta-do-desafio.php",
                                data: {desafio: id},
                                type: "POST",
                        ...
                        $(document).ready(function () {
                            ...
                            $.ajax({
                                dataType: "json",
                                url: "consultas/tentativa.php",
                                data: {desafio: id, jogador: Cookies.get("usuarioid")},
                                type: "POST",
                                success: function(result){
                                    swal("Tentativa registrada");
                                    tentativa = result.tentativa;
                                    matricula = result.matricula;
                                    
                                    pergunta();
                                    
                                    var fim = new Date(result.fim);
                                    fim = fim.getTime();
                                    ...
                                    setInterval(function() {
                                        ...
                                        $.ajax({
                                            dataType: "json",
                                            url: "consultas/hora-agora.php",
                                            type: "POST",
                                            success: function(result){
                                                agora = result.mensagem;
                                                var agora = new Date(agora);
                                                agora = agora.getTime();
                                                
                                                if(agora > fim){
                                                    window.location.href = "ranking.php?id="+id;  
                                                }
                                            }
                                        });
                                        ...
                                        $.ajax({
                                            dataType: "json",
                                            url: "consultas/ainda-jogando.php",
                                            data: {tentativa: tentativa},
                                            type: "POST",
                                            success: function(result){}
                                        });
                                    }, 10000); //10 segundos
                            ...
                            $("body").on("click", "a.resposta", function(){                                
                                if($(this).attr("id") === "s"){
                                    swal(
                                        ...
                                        var valor = parseInt($("#pontos").html()) + 1;
                                        $("#pontos").html(valor);
                                        
                                        $.ajax({
                                            dataType: "json",
                                            url: "consultas/incrementa.php",
                                            data: {pontos: valor, tentativa: tentativa},
                                            type: "POST",
                                            success: function(result){}
                                        });
