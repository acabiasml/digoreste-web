<!DOCTYPE html>
<head>
    <title>Gerência de Usuários | Digoreste</title>
        ...
        <section id="main-content">
            <section class="wrapper">
                <div class="agile-grid">
                    ...
                    <h2 style="font-family: exotc">Gerência de usuários</h2></br>
                        ...
                        $(document).ready(function(){
                            ...
                            window.operateEvents = {
                                "click .edit": function (e, value, row, index) {
                                    window.location.href = "usuario.php?id=" + row["0"];
                                },
                            ...
                            $.ajax({
                                dataType: "json",
                                url: "consultas/user-list.php",
                                type: "POST",
                                success: function(result){
                                    if(result.status === "erro"){
                                        swal("Não há outros usuários cadastrados.");
                                    }else{
